var Pe = Object.defineProperty, xe = Object.defineProperties;
...
var fe = (e, t, s) => t in e ? Pe(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : e[t] = s, u = (e, t) => {
  for (var s in t || (t = {}))
    Oe.call(t, s) && fe(e, s, t[s]);
  if (ce)
    for (var s of ce(t))
      Ae.call(t, s) && fe(e, s, t[s]);
  return e;
}, f = (e, t) => xe(e, je(t));
...
const be = {
  ...
  components: {
    ...
    VersaImageUpload: xt,
    VersaRepeater: _e(() => Promise.resolve().then(() => fs))
  },
  mixins: [ae, se],
  props: {
    /** 初始化时自动处理初始值 */
...
const Bt = /* @__PURE__ */ F(Et, [["render", Yt]]), Wt = {
  inject: {
    injectedProvide: {
      from: Le,
      default: {}
...
const Zt = /* @__PURE__ */ F(Ut, [["render", Ht]]);
const Gt = {
  cancel: {
    actionType: "cancel",
    actionName: "取消"
  ...
  computed: {
    ...
    dialogActions() {
      let e = typeof this.actions == "string" ? this.actions.split(",") : this.actions;
      return typeof this.actions == "function" && (e = this.actions(this.formValues)), e == null ? void 0 : e.map((t) => typeof t == "string" ? Gt[t] : P(t) && x(t, "actionName") && x(t, "actionType") || t != null && t.is ? f(u({}, t), {
        disabled: typeof t.disabled == "function" ? t.disabled.bind(this, this.formValues) : t.disabled
      }) : null).filter(Boolean);
    },
    /** 透传的props */
...
function Kt(e, t, s, i, a, r) {
  const o = g("VersaForm"), n = g("VersaButton"), p = g("ElSpace"), l = Ve("loading");
...
const Ne = /* @__PURE__ */ F(qt, [["render", Kt]]);
const Qt = {
  components: {
    VersaFilter: Rt,
    VersaTable: Zt,
...
const ri = /* @__PURE__ */ F(Qt, [["render", Xt]]);
const ai = {
  name: "versa-dropdown",
  inheritAttrs: !1,
  props: {
...
function ss(e, t, s, i, a, r) {
  return h(), _("td", ts, null, 512);
}
const is = /* @__PURE__ */ F(es, [["render", ss]]);
class ie {
  constructor(t) {
...
const G = z(ee, [
  ...
  inheritAttrs: !1,
  components: {
    VersaForm: _e(() => Promise.resolve().then(() => It)),
    VersaButton: Y,
    VersaModal: Ne,
    VersaMeasureCell: is,
    ElSpace: H
  ...
  ref: "formRef"
}, os = { class: "versa-repeater__table" }, ns = ["width"], us = { class: "versa-repeater__table-header" }, ds = { class: "versa-repeater__table-row" }, ps = { class: "versa-repeater__table-body" };
function hs(e, t, s, i, a, r) {
...
const cs = /* @__PURE__ */ F(as, [["render", hs]]), fs = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: cs
...
const li = /* @__PURE__ */ F(ms, [["render", ys]]);
export {
  Y as VersaButton,
  ue as VersaCard,
