var ke = Object.defineProperty, Fe = Object.defineProperties;
var De = Object.getOwnPropertyDescriptors;
var fe = Object.getOwnPropertySymbols;
var $e = Object.prototype.hasOwnProperty, Re = Object.prototype.propertyIsEnumerable;
var me = (e, t, s) => t in e ? ke(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : e[t] = s, u = (e, t) => {
  for (var s in t || (t = {}))
    $e.call(t, s) && me(e, s, t[s]);
  if (fe)
    for (var s of fe(t))
...
import _e from "lodash/upperFirst";
import { h as y, unref as Ve, resolveComponent as g, openBlock as h, createElementBlock as _, normalizeClass as q, createElementVNode as O, toDisplayString as D, renderSlot as C, createVNode as L, withCtx as m, Fragment as M, renderList as S, createBlock as b, resolveDynamicComponent as $, mergeProps as v, toHandlers as R, createTextVNode as W, createCommentVNode as B, defineAsyncComponent as we, normalizeProps as A, guardReactiveProps as T, createSlots as Y, resolveDirective as Me, withDirectives as Se, computed as Ce, normalizeStyle as Ee } from "vue";
import z from "lodash/pick";
import K from "lodash/mapKeys";
import de from "tiny-emitter";
import U from "lodash/omit";
import { ElOption as ye, ElOptionGroup as Ye, ElSelect as Be, ElMessageBox as ge, ElButton as We, ElPopconfirm as Ue, ElSpace as H, ElRadioButton as He, ElRadio as Ze, ElRadioGroup as Ge, ElIcon as qe, ElImage as Ke, ElCheckboxButton as Qe, ElCheckbox as Je, ElCheckboxGroup as Xe, ElRow as et, ElTableColumn as tt, ElLoading as Le, ElTable as st, ElEmpty as it, ElPagination as rt, ElDropdownItem as at, ElDropdown as lt, ElDropdownMenu as ot } from "element-plus";
...
import { Plus as pt, Delete as ht } from "@element-plus/icons-vue";
import "lodash/ceil";
...
import ct from "lodash/isFunction";
import ft from "lodash/upperCase";
...
const Ne = {
  ...
  computed: {
    pageCore() {
      return Ve(this.injectedPageCore);
    }
  },
  methods: {
    proxyPageCore(e) {
...
}, St = { class: "versa-card__title" }, Ct = { class: "versa-card__action" }, Lt = { class: "versa-card__content" };
function Nt(e, t, s, i, a, r) {
  const o = g("VersaButton"), n = g("ElSpace");
  return h(), _("div", {
    class: q(["versa-card", { "versa-card--hasTitle": s.title }])
  }, [
    s.title ? (h(), _("div", Mt, [
      O("div", St, D(s.title), 1),
      O("div", Ct, [
...
const se = /* @__PURE__ */ F(wt, [["render", Nt]]), be = {
  ...
  computed: {
    ...
    previewText() {
      ...
      return /.*date.*/.test(t) ? X(this.fieldValue).map((i) => J(i) ? null : typeof e == "string" ? nt(i).format(e) : i).filter(Boolean).join(" ~ ") : typeof e == "function" ? e(this.fieldValue, this.optionConfig) : this.fieldValue;
    },
    labelFor() {
    ...
    validate(e, t = k) {
      ...
      if (s.length !== 0) {
        ...
        s && s.length > 0 && s.forEach((l) => {
          delete l.trigger;
        }), n[this.prop] = s, new ut(n).validate(
  ...
  render() {
    var o, n, p, l, d, c, V, w, N, I, Z, he, ce;
    const e = [];
      ...
      f(u({
        ...
        class: [
          ...
          `versa-form-item--${this.status}`,
          {
            ...
            "is-no-asterisk": (he = this.VersaForm) == null ? void 0 : he.hideRequiredAsterisk,
    ...
    return !s && this.tips && !t ? y("div", {}, [
      ...
      y("div", {
        ...
        style: {
          "margin-left": this.labelStyle.width === "auto" ? (ce = this.VersaForm) == null ? void 0 : ce.autoLabelWidth : this.labelStyle.width
        },
        innerHTML: this.tips
      })
    ]) : r;
...
const Pt = {
  ...
  components: { Plus: pt, Delete: ht, ElIcon: qe, ElImage: Ke },
  props: {
    modelValue: {
      type: [Object, String]
    },
...
}, xt = { class: "versa-image-upload" }, jt = {
  key: 1,
  class: "versa-image-upload__preview"
}, Ot = /* @__PURE__ */ O("div", { class: "versa-image-upload__preview--mask" }, null, -1), At = ["accept"];
function It(e, t, s, i, a, r) {
  const o = g("Plus"), n = g("ElIcon"), p = g("ElImage"), l = g("Delete");
  return h(), _("div", xt, [
    a.previewSrc ? (h(), _("div", jt, [
      L(p, {
...
const Tt = /* @__PURE__ */ F(Pt, [["render", It]]), Oe = {
...
const ve = {
  ...
  components: {
    ...
    VersaImageUpload: Tt,
    VersaRepeater: we(() => Promise.resolve().then(() => gs))
  },
  mixins: [oe, ie],
  props: {
    /** 初始化时自动处理初始值 */
  ...
  computed: {
    ...
    deployOptions() {
      ...
      return (e = this.options) == null ? void 0 : e.filter((t) => typeof t.when == "function" ? t.when(this.model, t, {
        ...
        element: ve[t.element] || t.element,
        useCustomPreview: typeof t.useCustomPreview == "boolean" ? t.useCustomPreview : !!ve[t.element],
  ...
  methods: {
    ...
    addInitValue(e) {
      ...
      this.options.forEach((s) => {
        t[s.prop] = le(this.getInitValueByKey(s.prop, t, s));
    ...
    /** item组件props */
    bindFormItemProps(e) {
      const t = Object.keys(be.props).reduce((s, i) => f(u({}, s), {
        [i]: e[i]
      }), {});
      return u(f(u({}, t), {
        optionConfig: u({}, e)
    ...
    bindProps(e) {
      ...
      }, vt[e.type || "date"])), Object.assign(t, f(u({}, e), {
...
const re = /* @__PURE__ */ F(kt, [["render", Ft]]), Dt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: re
}, Symbol.toStringTag, { value: "Module" }));
const $t = z(ee, ["reset", "create", "search"]), Rt = {
  name: "versa-filter",
  components: {
    VersaForm: re,
    VersaCard: se,
  ...
  computed: {
    filterActions() {
      ...
      return typeof this.actions == "function" && (e = this.actions(this.formValues)), e == null ? void 0 : e.map((t) => typeof t == "string" ? $t[t] : P(t) && x(t, "actionName") && x(t, "actionType") || t != null && t.is ? f(u({}, t), {
...
}, zt = { class: "versa-filter__action" }, Et = { class: "versa-filter__footer" };
...
const Ae = /* @__PURE__ */ F(Rt, [["render", Yt]]), Bt = z(ee, ["remove", "edit", "detail"]), Wt = {
  ...
  methods: {
    ...
    filterActions(e, ...t) {
      ...
      return typeof e == "function" && (s = e(...t)), s == null ? void 0 : s.map((i) => typeof i == "string" ? Bt[i] : P(i) && x(i, "actionName") && x(i, "actionType") || i != null && i.is ? f(u({}, i), {
...
const Ht = /* @__PURE__ */ F(Wt, [["render", Ut]]), Zt = {
  inject: {
    injectedProvide: {
      from: xe,
      default: {}
  ...
  computed: {
    globalConfig() {
      return Ve(this.injectedProvide);
    }
  }
};
const Gt = {
...
function qt(e, t, s, i, a, r) {
  const o = g("VersaButton"), n = g("ElSpace"), p = g("ElEmpty"), l = g("VersaNestedTable"), d = g("ElTable"), c = g("ElPagination"), V = g("VersaCard"), w = Me("loading");
  return Se((h(), b(V, {
    class: "versa-table",
    title: e.headline
  }, {
...
const Ie = /* @__PURE__ */ F(Gt, [["render", qt]]);
const Kt = {
  cancel: {
    actionType: "cancel",
    actionName: "取消"
  ...
  computed: {
    ...
    dialogActions() {
      let e = typeof this.actions == "string" ? this.actions.split(",") : this.actions;
      return typeof this.actions == "function" && (e = this.actions(this.formValues)), e == null ? void 0 : e.map((t) => typeof t == "string" ? Kt[t] : P(t) && x(t, "actionName") && x(t, "actionType") || t != null && t.is ? f(u({}, t), {
        disabled: typeof t.disabled == "function" ? t.disabled.bind(this, this.formValues) : t.disabled
      }) : null).filter(Boolean);
    },
    /** 透传的props */
...
function Jt(e, t, s, i, a, r) {
  const o = g("VersaForm"), n = g("VersaButton"), p = g("ElSpace"), l = Me("loading");
...
const pe = /* @__PURE__ */ F(Qt, [["render", Jt]]);
const Xt = {
  components: {
    VersaFilter: Ae,
    VersaTable: Ie,
...
function ls(e, t, s, i, a, r) {
  return h(), _("td", as, null, 512);
}
const os = /* @__PURE__ */ F(rs, [["render", ls]]);
class ae {
  constructor(t) {
...
const G = z(ee, [
  ...
  inheritAttrs: !1,
  components: {
    VersaForm: we(() => Promise.resolve().then(() => Dt)),
    VersaButton: E,
    VersaModal: pe,
    VersaMeasureCell: os,
    ElSpace: H
  ...
  watch: {
    modelValue: {
      handler(e) {
        var t;
        this.formList = (t = e == null ? void 0 : e.map((s) => this.formList.find((a) => a.values === s || a.temporaryValues === s || s[this.rowKey] && a.values[this.rowKey] === s[this.rowKey] || s.__rowKey && a.values.__rowKey === s.__rowKey) || new ae({
          values: s,
          type: this.type,
    ...
    onAdd() {
      return j(this, null, function* () {
        ...
        const [s, i] = yield this.handleAsyncAction(
          "add",
          f(u({}, this.initValue), { __rowKey: `repeater_${mt()}` }),
          e
        );
        if (!s)
          return;
        ...
        const a = new ae({
          ...
          mounted: (r) => {
            this.type === "inline" && (r.temporaryValues = r.values, r.values = le(r.values), r.status = "edit");
          }
        });
  ...
  ref: "formRef"
}, ps = { class: "versa-repeater__table" }, hs = ["width"], cs = { class: "versa-repeater__table-header" }, fs = { class: "versa-repeater__table-row" }, ms = { class: "versa-repeater__table-body" };
function ys(e, t, s, i, a, r) {
        ...
        O("thead", cs, [
          O("tr", fs, [
            (h(!0), _(M, null, S(r.deployOptions, (c) => (h(), _("th", {
              ...
              style: Ee(c.formItemProps.itemStyle)
            }, D(c.__label), 7))), 256))
          ])
        ]),
        O("tbody", ms, [
...
const Te = /* @__PURE__ */ F(us, [["render", ys]]), gs = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Te
...
const _s = /* @__PURE__ */ F(bs, [["render", vs]]), Vs = [
  ss,
  Ae,
  Ie,
  re,
