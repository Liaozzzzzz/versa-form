...
function Yt(e, t, s, i, r, a) {
  ...
  return f(), b("div", {
    ...
    s.title ? (f(), b("div", zt, [
      C("div", Pt, x(s.title), 1),
      C("div", Et, [
        S(e.$slots, "headerRight", {}, () => [
          D(o, { size: 20 }, {
            default: g(() => [
              (f(!0), b(j, null, V(a.toolActions, (d) => (f(), b(j, null, [
                d.is ? (f(), v(k(d.is), w({
                  key: d.is,
                  ref_for: !0
...
function Wt(e, t, s, i, r, a) {
  return a.renderValue ? (f(), b("span", Bt, [
    Z(x(a.renderValue) + " ", 1),
    C("img", {
...
}, Jt = /* @__PURE__ */ C("div", { class: "versa-image-upload__preview--mask" }, null, -1), qt = ["accept"];
function Kt(e, t, s, i, r, a) {
  const u = M("Plus"), o = M("ElIcon"), d = M("ElImage"), l = M("Delete");
  return f(), b("div", Qt, [
    r.previewSrc ? (f(), b("div", Gt, [
      D(d, {
  ...
  return f(), v(k(s.component), {
    ...
    default: g(() => [
      a.layout ? (f(), v(d, {
        ...
        default: g(() => [
          (f(!0), b(j, null, V(a.deployOptions, (l) => (f(), v(o, {
            key: l.prop,
            span: l.colSpan
          }, {
            default: g(() => [
        ...
        _: 3
      })) : (f(!0), b(j, { key: 1 }, V(a.deployOptions, (l) => (f(), v(u, w({ ref_for: !0 }, a.bindFormItemProps(l), {
        hasToolTip: a.hasToolTip,
        key: l.prop,
        prop: l.prop,
        label: l.label || "",
...
const ss = P(ee, ["reset", "create", "search"]), is = {
  ...
  computed: {
    filterActions() {
      ...
      return typeof this.actions == "function" && (e = this.actions(this.formValues)), e == null ? void 0 : e.map((t) => typeof t == "string" ? ss[t] : L(t) && I(t, "actionName") && I(t, "actionType") || t != null && t.is ? m(n({}, t), {
        ...
        footer: g(() => [
          C("section", rs, [
            D(o, {
              ...
              default: g(() => [
                (f(!0), b(j, null, V(a.filterActions, (h) => (f(), b(j, null, [
                  h.is ? (f(), v(k(h.is), w({
                    key: 0,
                    ref_for: !0
...
const os = P(ee, ["remove", "edit", "detail"]), ke = {
  ...
  methods: {
    ...
    filterActions(e, ...t) {
      ...
      return typeof e == "function" && (s = e(...t)), s == null ? void 0 : s.map((i) => typeof i == "string" ? os[i] : L(i) && I(i, "actionName") && I(i, "actionType") || i != null && i.is ? m(n({}, i), {
        on: we(i.on),
...
const ns = {
  ...
  computed: {
    ...
    dialogActions() {
      let e = typeof this.actions == "string" ? this.actions.split(",") : this.actions;
      return typeof this.actions == "function" && (e = this.actions(this.formValues)), e == null ? void 0 : e.map((t) => typeof t == "string" ? ns[t] : L(t) && I(t, "actionName") && I(t, "actionType") || t != null && t.is ? m(n({}, t), {
        disabled: typeof t.disabled == "function" ? t.disabled.bind(this, this.formValues) : t.disabled
      }) : null).filter(Boolean);
    },
    /** 透传的props */
  ...
  return a.dialogVisible ? (f(), v(k(s.panelType), w({
    ...
    default: g(() => [
      ...
      a.dialogActions.length ? (f(), v(d, {
        ...
        default: g(() => [
          (f(!0), b(j, null, V(a.dialogActions, (h) => (f(), b(j, {
            key: h.actionType
          }, [
            h.is ? (f(), v(k(h.is), w({
              key: 0,
...
function Vs(e, t, s, i, r, a) {
  ...
  return f(), b("div", Ns, [
    C("div", {
      ...
      C("table", Ls, [
        C("colgroup", null, [
          (f(!0), b(j, null, V(a.deployOptions, (p) => (f(), b("col", {
            width: p.__width || "auto"
          }, null, 8, _s))), 256))
        ]),
        C("thead", Cs, [
          C("tr", Is, [
            (f(!0), b(j, null, V(a.deployOptions, (p) => (f(), b("th", {
              class: J([
        ...
        C("tbody", js, [
          C("tr", null, [
            (f(!0), b(j, null, V(a.deployOptions, (p) => (f(), v(u, {
              key: p.prop,
              measure: !!p.fixed,
              onOnResize: (y) => a.onResize(p, y)
            }, null, 8, ["measure", "onOnResize"]))), 128))
          ]),
          (f(!0), b(j, null, V(r.formList, (p, y) => (f(), v(l, {
            component: "tr",
            isRepeater: "",
            ref_for: !0,
            ref: "repeaterRows",
            ...
            a.hasOperateColumn ? {
              ...
              fn: g(() => [
                D(d, null, {
                  default: g(() => [
                    (f(!0), b(j, null, V(a.filterActions(p, y), (N) => (f(), b(j, null, [
                      N.is ? (f(), v(k(N.is), w({
                        key: 0,
                        ref_for: !0
