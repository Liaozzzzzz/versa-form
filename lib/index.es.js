  ...
  return p(), _("div", Vt, [
    a.previewSrc ? (p(), _("div", wt, [
      L(h, {
        ...
        fit: "cover"
      }, null, 8, ["src", "zoom-rate", "min-scale", "preview-src-list"]),
  ...
  return p(), b(D(s.component), {
    ...
    default: m(() => [
      r.layout ? (p(), b(h, {
              ...
              L(o, v(r.bindFormItemProps(l), {
                ...
                default: m(() => [
                  l.slotName ? C(e.$slots, l.slotName, v({
                    key: 0,
                    data: r.model
                  }, l)) : (p(), b(D(l.element), v({ key: 1 }, R(r.bindEvent(l)), r.bindProps(l), {
        ...
        _: 3
      })) : (p(!0), _(M, { key: 1 }, S(r.deployOptions, (l) => (p(), b(o, v(r.bindFormItemProps(l), {
        key: l.prop,
        prop: l.prop,
        label: l.label || "",
        rules: l.rules,
            ...
            L(n, {
              ...
              default: m(() => [
                (p(!0), _(M, null, S(r.filterActions, (d) => (p(), _(M, null, [
                  d.is ? (p(), b(D(d.is), v({ key: 0 }, d, R(d.on || {})), null, 16)) : (p(), b(o, v({
                    key: d.actionType,
                    type: d.type
                  }, d, {
      ...
      L(h, null, {
        default: m(() => [
          (p(!0), _(M, null, S(r.filterActions(
            ...
            w.is ? (p(), b(D(w.is), v({ key: 0 }, w, R(w.on || {})), null, 16)) : (p(), b(n, v({
              key: 1,
              type: "primary",
              link: ""
            }, w, {
      ...
      L(n, {
        ...
        default: m(() => [
          (p(!0), _(M, null, S(r.tools, (N) => (p(), _(M, null, [
            N.is ? (p(), b(D(N.is), v({ key: 0 }, N, R(N.on || {})), null, 16)) : (p(), b(o, v({ key: 1 }, N, {
      ...
      r.dialogActions.length ? (p(), b(h, {
        ...
        default: m(() => [
          (p(!0), _(M, null, S(r.dialogActions, (d) => (p(), _(M, {
            ...
            d.is ? (p(), b(D(d.is), v({ key: 0 }, d, R(d.on || {})), null, 16)) : E("", !0),
            L(n, v(d, {
              onClick: (c, V) => r.onAction(d, V)
            }), {
              default: m(() => [
