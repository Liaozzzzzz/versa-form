var Re = Object.defineProperty, ke = Object.defineProperties;
...
var ge = (e, t, s) => t in e ? Re(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : e[t] = s, n = (e, t) => {
  for (var s in t || (t = {}))
    Ee.call(t, s) && ge(e, s, t[s]);
  if (ye)
    for (var s of ye(t))
      Ye.call(t, s) && ge(e, s, t[s]);
  return e;
}, f = (e, t) => ke(e, ze(t));
...
import { h as p, unref as Me, resolveComponent as g, openBlock as m, createElementBlock as b, normalizeClass as q, createElementVNode as L, toDisplayString as F, renderSlot as N, createVNode as j, withCtx as y, Fragment as x, renderList as P, createBlock as _, resolveDynamicComponent as R, mergeProps as V, toHandlers as k, createTextVNode as Q, createCommentVNode as W, defineAsyncComponent as Se, normalizeProps as O, guardReactiveProps as A, createSlots as U, withDirectives as Ce, resolveDirective as We, computed as Le, normalizeStyle as Ue } from "vue";
import T from "lodash/pick";
import H from "lodash/mapKeys";
import ue from "tiny-emitter";
import z from "lodash/omit";
import { ElOption as be, ElOptionGroup as He, ElSelect as Ze, ElMessageBox as ve, ElButton as Ge, ElPopconfirm as qe, ElSpace as E, ElRadioButton as Qe, ElRadio as Je, ElRadioGroup as Ke, ElIcon as Xe, ElImage as et, ElCheckboxButton as tt, ElCheckbox as st, ElCheckboxGroup as it, ElRow as rt, ElTable as at, ElEmpty as lt, ElPagination as ot, ElLoading as xe, ElTableColumn as Z, ElDialog as nt, ElDropdownItem as ut, ElDropdown as dt, ElDropdownMenu as ht, ElMessage as pt } from "element-plus";
...
import ft from "async-validator";
import mt from "lodash/debounce";
...
import { Plus as yt, Delete as gt } from "@element-plus/icons-vue";
import bt from "lodash/ceil";
...
const J = (e) => ["", null, void 0].includes(e), I = (e) => e, M = (e) => Object.prototype.toString.call(e).toLocaleLowerCase() === "[object object]", S = (e, t) => Object.prototype.hasOwnProperty.call(e, t);
function X(e) {
  return e == null ? [] : Array.isArray(e) ? e : [e];
}
const Vt = () => Math.random().toString(36).slice(2), _e = (e = {}) => {
  const t = {};
  for (const s in e)
...
const $ = {
  ...
  render() {
    const e = f(n({}, z(this.$attrs, [
      ...
      onClick: this.isPopconfirm ? I : this.debouncedClick,
    ...
    return this.isPopconfirm ? p(
      ...
      f(n({}, this.confirmProps), {
        onCancel: this.$attrs.onCancel || I,
...
}, jt = { class: "versa-card__title" }, It = { class: "versa-card__action" }, Ot = { class: "versa-card__content" };
function At(e, t, s, i, r, a) {
  const u = g("VersaButton"), o = g("ElSpace");
  return m(), b("div", {
    class: q(["versa-card", { "versa-card--hasTitle": s.title }])
  }, [
    s.title ? (m(), b("div", Nt, [
      L("div", jt, F(s.title), 1),
      L("div", It, [
...
const te = /* @__PURE__ */ D(Pt, [["render", At]]), Ve = {
  ...
  computed: {
    ...
    previewText() {
      ...
      return /.*date.*/.test(t) ? X(this.fieldValue).map((i) => J(i) ? null : typeof e == "string" ? ct(i).format(e) : i).filter(Boolean).join(" ~ ") : typeof e == "function" ? e(this.fieldValue, this.optionConfig) : this.fieldValue;
    },
    labelFor() {
    ...
    validate(e, t = I) {
      ...
      if (s.length !== 0) {
        ...
        s && s.length > 0 && s.forEach((l) => {
          delete l.trigger;
        }), o[this.prop] = s, new ft(o).validate(
  ...
  render() {
    var u, o, d, l, h, c, v, w, Y, K, ce, fe, me;
    const e = [];
        ...
        (K = (v = (c = this.$slots).error) == null ? void 0 : v.call(c, {
          ...
          "div",
          {
            class: [
              ...
              {
                "versa-form-item__error--inline": typeof this.inlineMessage == "boolean" ? this.inlineMessage : (Y = (w = this.VersaForm) == null ? void 0 : w.inlineMessage) != null ? Y : !1
              }
            ]
          },
...
const Tt = {
  ...
  components: { Plus: yt, Delete: gt, ElIcon: Xe, ElImage: et },
  mixins: [Oe],
  props: {
    modelValue: {
      type: [Object, String]
    ...
    handleChange(e) {
      ...
      if (t[0].size > this.maxSize) {
        (u = (a = this.globalConfig) == null ? void 0 : a.toastError) == null || u.call(
          a,
          `最大支持${bt(this.maxSize / 1e3, 2)}kb大小的文件`
        );
        return;
      }
...
}, $t = { class: "versa-image-upload" }, Dt = {
  key: 1,
  class: "versa-image-upload__preview"
}, Ft = /* @__PURE__ */ L("div", { class: "versa-image-upload__preview--mask" }, null, -1), Rt = ["accept"];
function kt(e, t, s, i, r, a) {
  const u = g("Plus"), o = g("ElIcon"), d = g("ElImage"), l = g("Delete");
  return m(), b("div", $t, [
    r.previewSrc ? (m(), b("div", Dt, [
      j(d, {
...
const Ae = /* @__PURE__ */ D(Tt, [["render", kt]]), Te = {
...
const we = {
  ...
  components: {
    ...
    VersaFormItem: Ve,
    VersaRadioGroup: Ie,
    VersaCheckboxGroup: Te,
    VersaImageUpload: Ae,
    VersaRepeater: Se(() => Promise.resolve().then(() => ys))
  },
  mixins: [ae, he],
  props: {
    /** 初始化时自动处理初始值 */
  ...
  methods: {
    ...
    bindProps(e) {
      ...
      }, Ct[e.type || "date"])), Object.assign(t, f(n({}, e), {
...
function Et(e, t, s, i, r, a) {
  ...
  return m(), _(R(s.component), {
    ...
    default: y(() => [
      ...
      N(e.$slots, "footer", O(A({ model: a.model, actionType: e.actionType })))
    ]),
    _: 3
  }, 8, ["class"]);
}
const se = /* @__PURE__ */ D(zt, [["render", Et]]), Yt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: se
}, Symbol.toStringTag, { value: "Module" }));
const Bt = T(ee, ["reset", "create", "search"]), Wt = {
  name: "versa-filter",
  components: {
    VersaForm: se,
    VersaCard: te,
  ...
  computed: {
    filterActions() {
      ...
      return typeof this.actions == "function" && (e = this.actions(this.formValues)), e == null ? void 0 : e.map((t) => typeof t == "string" ? Bt[t] : M(t) && S(t, "actionName") && S(t, "actionType") || t != null && t.is ? f(n({}, t), {
...
}, Ut = { class: "versa-filter__action" }, Ht = { class: "versa-filter__footer" };
          ...
          L("section", Ut, [
            j(o, {
              ...
              default: y(() => [
                ...
                N(e.$slots, "btns", O(A(e.proxyPageCore({ formValues: r.formValues }))))
              ]),
              _: 3
            })
          ])
...
const $e = /* @__PURE__ */ D(Wt, [["render", Zt]]);
const Gt = T(ee, ["remove", "edit", "detail"]), De = {
  name: "versa-table",
  mixins: [oe, he, de, Oe],
  props: {
    /** 列表配置项 */
  ...
  methods: {
    ...
    onAction(e, t, s) {
      ...
      if (e.usePageModal) {
        this.dispatch("versa-page", "VersaFormPageUsePageModal", t, f(n({}, i), {
    ...
    filterActions(e, ...t) {
      ...
      return typeof e == "function" && (s = e(...t)), s == null ? void 0 : s.map((i) => typeof i == "string" ? Gt[i] : M(i) && S(i, "actionName") && S(i, "actionType") || i != null && i.is ? f(n({}, i), {
        on: _e(i.on),
              ...
              p(
                ...
                }),
                {
                  empty: () => {
                    ...
                    )) != null ? a : p(lt, { description: "暂无数据" });
                  },
                  default: () => e(this.renderOptions)
                }
              ),
              this.needPagination && this.innerParams.total > 0 ? p(ot, f(n({
...
const qt = {
  ...
  computed: {
    ...
    dialogActions() {
      let e = typeof this.actions == "string" ? this.actions.split(",") : this.actions;
      return typeof this.actions == "function" && (e = this.actions(this.formValues)), e == null ? void 0 : e.map((t) => typeof t == "string" ? qt[t] : M(t) && S(t, "actionName") && S(t, "actionType") || t != null && t.is ? f(n({}, t), {
        disabled: typeof t.disabled == "function" ? t.disabled.bind(this, this.formValues) : t.disabled
      }) : null).filter(Boolean);
    },
    /** 透传的props */
...
function Jt(e, t, s, i, r, a) {
  const u = g("VersaForm"), o = g("VersaButton"), d = g("ElSpace"), l = We("loading");
  return a.dialogVisible ? (m(), _(R(s.panelType), V({
    ...
    default: y(() => [
      Ce((m(), _(u, V(a.mergedFormProps, {
        ...
        footer: y((h) => [
          N(e.$slots, "modalFooter", O(A(f(n({}, h), { loading: r.loading, refresh: a.initForm }))))
        ]),
        _: 2
      }, [
        P(Object.keys(e.$slots).filter(
...
const pe = /* @__PURE__ */ D(Qt, [["render", Jt]]);
const Kt = {
  components: {
    VersaFilter: $e,
    VersaTable: De,
...
const ts = /* @__PURE__ */ D(Kt, [["render", es]]);
const ss = {
  name: "versa-dropdown",
  inheritAttrs: !1,
  props: {
...
function as(e, t, s, i, r, a) {
  return m(), b("td", rs, null, 512);
}
const ls = /* @__PURE__ */ D(is, [["render", as]]);
class ie {
  constructor(t) {
    const { type: s, values: i, status: r, mounted: a = I, isNew: u = !1 } = t;
...
const B = T(ee, [
  ...
  inheritAttrs: !1,
  components: {
    VersaForm: Se(() => Promise.resolve().then(() => Yt)),
    VersaButton: $,
    VersaModal: pe,
    VersaMeasureCell: ls,
    ElSpace: E
    ...
    deployOptions() {
      ...
      return [].concat(e, s, t).map((r) => {
        ...
        if (r.fixed) {
          ...
          let v = 0;
          c.some((w) => {
            const Y = w.prop === r.prop;
            return Y || (v += this.fixedColumnWidth[w.prop] || 0), Y;
    ...
    onAdd() {
      return C(this, null, function* () {
        ...
        const [s, i] = yield this.handleAsyncAction(
          "add",
          f(n({}, this.initValue), { __rowKey: `repeater_${Vt()}` }),
          e
        );
        if (!s)
          return;
  ...
  ref: "formRef"
}, ds = { class: "versa-repeater__table" }, hs = ["width"], ps = { class: "versa-repeater__table-header" }, cs = { class: "versa-repeater__table-row" }, fs = { class: "versa-repeater__table-body" };
        ...
        L("thead", ps, [
          L("tr", cs, [
            (m(!0), b(x, null, P(a.deployOptions, (c) => (m(), b("th", {
              ...
              style: Ue(c.formItemProps.itemStyle)
            }, F(c.__label), 7))), 256))
          ])
        ]),
        L("tbody", fs, [
                  ...
                  default: y(() => [
                    (m(!0), b(x, null, P(a.filterActions(c, v), (w) => (m(), b(x, null, [
                      w.is ? (m(), _(R(w.is), V({
                        ...
                        onClick: (Y, K) => a.onAction(w, c, v, K)
                      }), {
                        default: y(() => [
                          Q(F(w.actionName), 1)
                        ]),
...
const Fe = /* @__PURE__ */ D(ns, [["render", ms]]), ys = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Fe
  ...
  props: {
    ...
    toastError: {
      type: Function,
      default: (e) => pt({ message: e, type: "error" })
    }
  },
  data() {
    return {};
...
const vs = /* @__PURE__ */ D(gs, [["render", bs]]), _s = [
  ts,
  $e,
  De,
  se,
  ...
  _s.forEach((t) => {
    e.component(ne(Be(t.name)), t);
  });
};
export {
  $ as VersaButton,
  te as VersaCard,
  Te as VersaCheckboxGroup,
  ss as VersaDropdown,
  $e as VersaFilter,
  se as VersaForm,
  pe as VersaModal,
