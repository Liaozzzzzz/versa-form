var Re = Object.defineProperty, Be = Object.defineProperties;
...
var be = (e, t, s) => t in e ? Re(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : e[t] = s, u = (e, t) => {
  for (var s in t || (t = {}))
    We.call(t, s) && be(e, s, t[s]);
  if (ve)
    for (var s of ve(t))
      Ze.call(t, s) && be(e, s, t[s]);
  return e;
}, m = (e, t) => Be(e, Ue(t));
var V = (e, t, s) => new Promise((i, a) => {
  var r = (d) => {
    try {
      o(s.next(d));
    } catch (p) {
...
import He from "lodash/camelCase";
import de from "lodash/upperFirst";
import { h, unref as Ie, resolveComponent as b, openBlock as f, createElementBlock as v, normalizeClass as J, createElementVNode as L, toDisplayString as x, renderSlot as _, createVNode as D, withCtx as g, Fragment as I, renderList as C, createBlock as w, resolveDynamicComponent as O, mergeProps as M, toHandlers as z, createTextVNode as B, createCommentVNode as $, Transition as Qe, withDirectives as ce, vShow as Ge, defineAsyncComponent as Se, createSlots as P, normalizeProps as E, guardReactiveProps as k, resolveDirective as Je, computed as Ve, normalizeStyle as qe } from "vue";
import F from "lodash/pick";
import H from "lodash/mapKeys";
import pe from "tiny-emitter";
import R from "lodash/omit";
import { ElOption as we, ElOptionGroup as Ke, ElSelect as Xe, ElMessageBox as _e, ElButton as et, ElPopconfirm as tt, ElSpace as Q, ElTooltip as st, ElRadioButton as it, ElRadio as rt, ElRadioGroup as at, ElIcon as lt, ElImage as ot, ElCheckboxButton as nt, ElCheckbox as ut, ElCheckboxGroup as dt, ElRow as ct, ElCol as pt, ElTable as ht, ElEmpty as ft, ElPagination as mt, ElLoading as je, ElTableColumn as W, ElDialog as yt, ElDrawer as gt, ElDropdownItem as Mt, ElDropdown as vt, ElDropdownMenu as bt, ElMessage as wt } from "element-plus";
...
import Nt from "async-validator";
...
import { Plus as Ct, Delete as It } from "@element-plus/icons-vue";
import St from "lodash/ceil";
...
const q = (e) => ["", null, void 0].includes(e), A = (e) => e, S = (e) => Object.prototype.toString.call(e).toLocaleLowerCase() === "[object object]", j = (e, t) => Object.prototype.hasOwnProperty.call(e, t);
function X(e) {
...
const Dt = (e, t) => {
  ...
  if (typeof t == "function")
    return t(e);
}, Tt = () => Math.random().toString(36).slice(2), Ne = (e = {}) => {
  const t = {};
  for (const s in e)
...
const De = {
    ...
    innerValue: {
      ...
      set(e) {
        ...
        const t = X(e), i = ((r = (a = this.mergedOptions) == null ? void 0 : a.filter(
          ...
          let o = F(n, ["label", "value"]);
          return S(this.labelInValue) && (o = H(o, (d, p) => this.labelInValue[p] || p)), o;
        });
        this.$emit(
          "update:modelValue",
          this.multiple ? i : i[0]
  ...
  computed: {
    pageCore() {
      return Ie(this.injectedPageCore);
    }
  },
  methods: {
    proxyPageCore(e) {
...
const T = (e, t) => {
  ...
  computed: {
    ...
    toolActions() {
      var e, t;
      return (t = (e = this.actions) == null ? void 0 : e.map((s) => S(s) && j(s, "actionName") && j(s, "actionType") || s != null && s.is ? m(u({}, s), {
...
}, $t = { class: "versa-card__title" }, Rt = { class: "versa-card__action" }, Bt = { class: "versa-card__content" };
    ...
    s.title ? (f(), v("div", Yt, [
      ...
      L("div", Rt, [
        _(e.$slots, "headerRight", {}, () => [
          D(o, { size: 20 }, {
            default: g(() => [
              (f(!0), v(I, null, C(r.toolActions, (d) => (f(), v(I, null, [
                d.is ? (f(), w(O(d.is), M({
                  key: d.is,
                  ref_for: !0
                }, d, z(d.on || {})), null, 16)) : (f(), w(n, M({
                  key: d.type,
                  size: "small",
                  ref_for: !0
                }, d, {
  ...
  computed: {
    ...
    labelConfig() {
      ...
      return typeof this.labelType == "string" ? m(u({}, e), {
        type: this.labelType
      }) : S(this.labelType) ? u(u({}, e), this.labelType) : e;
    },
    optionConfig() {
    ...
    validate(e, t = A) {
      ...
      if (s.length !== 0) {
        ...
        s && s.length > 0 && s.forEach((p) => {
          delete p.trigger;
        }), o[this.prop] = s, new Nt(o).validate(
...
}, ss = { class: "versa-collapse" }, is = /* @__PURE__ */ L("button", { type: "button" }, "展开/折叠", -1), rs = { class: "versa-collapse__content" };
...
const ls = /* @__PURE__ */ T(ts, [["render", as]]), Oe = {
  ...
  computed: {
    ...
    innerValue: {
      ...
      set(e) {
        ...
        let s = F(t, ["label", "value"]);
        S(this.labelInValue) && (s = H(
          s,
  ...
  computed: {
    globalConfig() {
      return Ie(this.injectedProvide);
    }
  }
};
const os = {
  name: "versa-image-upload",
  components: { Plus: Ct, Delete: It, ElIcon: lt, ElImage: ot },
  mixins: [ze],
  props: {
    modelValue: {
      type: [Object, String]
      ...
      return V(this, null, function* () {
        ...
        if (t[0].size > this.maxSize) {
          (n = (r = this.globalConfig) == null ? void 0 : r.toastError) == null || n.call(
            r,
            `最大支持${St(this.maxSize / 1e3, 2)}kb大小的文件`
          );
          return;
        }
...
}, ds = /* @__PURE__ */ L("div", { class: "versa-image-upload__preview--mask" }, null, -1), cs = ["accept"];
...
const Pe = /* @__PURE__ */ T(os, [["render", ps]]), Ee = {
    ...
    innerValue: {
      ...
      set(e) {
        ...
        const s = ((a = (i = this.mergedOptions) == null ? void 0 : i.filter(
          ...
          let n = F(r, ["label", "value"]);
          return S(this.labelInValue) && (n = H(n, (o, d) => this.labelInValue[d] || d)), n;
        });
        this.$emit("update:modelValue", s);
      }
    },
...
const Ce = {
  ...
  components: {
    ...
    VersaFormItem: Le,
    VersaRadioGroup: Oe,
    VersaCheckboxGroup: Ee,
    VersaImageUpload: Pe,
    VersaFormCollapse: ls,
    VersaRepeater: Se(() => Promise.resolve().then(() => Bs))
  },
  mixins: [oe, fe],
  props: {
    /** 初始化时自动处理初始值 */
  ...
  methods: {
    ...
    /** item组件props */
    bindFormItemProps(e) {
      const t = Object.keys(Le.props).reduce((s, i) => m(u({}, s), {
        [i]: e[i]
      }), {});
      return u(m(u({}, t), {
        optionConfig: u({}, e)
  ...
  return f(), w(O(s.component), {
    ...
    default: g(() => [
      r.layout ? (f(), w(d, {
        ...
        default: g(() => [
          (f(!0), v(I, null, C(r.deployOptions, (l) => (f(), w(o, {
            key: l.prop,
            span: l.colSpan
          }, {
            default: g(() => [
              D(n, M({ ref_for: !0 }, r.bindFormItemProps(l), {
                ...
                default: g(() => [
                  l.slotName ? _(e.$slots, l.slotName, M({
                    ...
                    data: r.model,
                    ref_for: !0
                  }, l)) : (f(), w(O(l.element), M({ key: 1 }, z(r.bindEvent(l)), { ref_for: !0 }, r.bindProps(l), {
        ...
        _: 3
      })) : (f(!0), v(I, { key: 1 }, C(r.deployOptions, (l) => (f(), v(I, {
        key: l.prop
      }, [
        l.element === "versa-form-collapse" ? (f(), w(p, M({
          ...
          default: g(() => [
            (f(!0), v(I, null, C(l.options, (c) => (f(), w(n, M({ ref_for: !0 }, r.bindFormItemProps(c), {
              hasToolTip: r.hasToolTip,
              prop: c.prop,
              label: c.label || "",
              rules: c.rules,
              ...
              default: g(() => [
                c.slotName ? _(e.$slots, c.slotName, M({
                  ...
                  data: r.model,
                  ref_for: !0
                }, c)) : (f(), w(O(c.element), M({ key: 1 }, z(r.bindEvent(c)), { ref_for: !0 }, r.bindProps(c), {
      ...
      _(e.$slots, "footer", E(k({ model: r.model, actionType: e.actionType })))
    ]),
    _: 3
  }, 8, ["class"]);
}
...
const ys = F(te, ["reset", "create", "search"]), gs = {
  name: "versa-filter",
  components: {
    VersaForm: ie,
    VersaCard: se,
  ...
  computed: {
    filterActions() {
      ...
      return typeof this.actions == "function" && (e = this.actions(this.formValues)), e == null ? void 0 : e.map((t) => typeof t == "string" ? ys[t] : S(t) && j(t, "actionName") && j(t, "actionType") || t != null && t.is ? m(u({}, t), {
        ...
        footer: g(() => [
          L("section", Ms, [
            D(o, {
              ...
              default: g(() => [
                (f(!0), v(I, null, C(r.filterActions, (l) => (f(), v(I, null, [
                  l.is ? (f(), w(O(l.is), M({
                    key: 0,
                    ref_for: !0
                  }, l, z(l.on || {})), null, 16)) : (f(), w(n, M({
                    key: l.actionType,
                    type: l.type,
                    ref_for: !0
                  }, l, {
                ...
                _(e.$slots, "btns", E(k(e.proxyPageCore({ formValues: a.formValues }))))
              ]),
              _: 3
            })
          ])
...
const ke = /* @__PURE__ */ T(gs, [["render", bs]]);
const ws = F(te, ["remove", "edit", "detail"]), Fe = {
  name: "versa-table",
  mixins: [ue, fe, he, ze],
  props: {
    /** 列表配置项 */
  ...
  computed: {
    tools() {
      var e;
      return (e = this.toolOptions) == null ? void 0 : e.map((t) => S(t) && j(t, "actionName") && j(t, "actionType") || t != null && t.is ? m(u({}, t), {
        on: Ne(t.on),
    ...
    renderOptions() {
      ...
      return (t = (e = this.options) == null ? void 0 : e.map((s) => {
        ...
        return i.formatter || (i.formatter = (a) => {
          var r, n, o;
          return q(a[i.prop]) ? i.filterNull || ((r = this.fillNull) != null ? r : "") : S(i.mapSource) ? i.mapSource[a[i.prop]] : Array.isArray(i.mapSource) ? (o = (n = i.mapSource.find(
            (d) => d.value === a[i.prop]
  ...
  methods: {
    queryTableData() {
      return V(this, null, function* () {
        var e, t;
        try {
          const s = this.formatFilter(u(u({}, R(this.innerParams, ["total"])), this.queryParams));
          this.loading = !0;
          let i;
          if (Vt(this.api))
            i = yield this.api(s);
    ...
    filterActions(e, ...t) {
      ...
      return typeof e == "function" && (s = e(...t)), s == null ? void 0 : s.map((i) => typeof i == "string" ? ws[i] : S(i) && j(i, "actionName") && j(i, "actionType") || i != null && i.is ? m(u({}, i), {
        on: Ne(i.on),
  ...
  render() {
    const e = (t) => t.map((s) => {
      ...
      }) : ((i = s.children) == null ? void 0 : i.length) > 0 ? h(W, ...R(s, ["children"]), {
        default: () => e(s.children)
      }) : s.sensitive ? h(W, s, {
        default: ({ row: a, column: r }) => h(xe, {
          value: a[r.property],
...
const _s = {
  ...
  computed: {
    ...
    dialogActions() {
      let e = typeof this.actions == "string" ? this.actions.split(",") : this.actions;
      return typeof this.actions == "function" && (e = this.actions(this.formValues)), e == null ? void 0 : e.map((t) => typeof t == "string" ? _s[t] : S(t) && j(t, "actionName") && j(t, "actionType") || t != null && t.is ? m(u({}, t), {
        disabled: typeof t.disabled == "function" ? t.disabled.bind(this, this.formValues) : t.disabled
      }) : null).filter(Boolean);
    },
    /** 透传的props */
...
function Ls(e, t, s, i, a, r) {
  const n = b("VersaForm"), o = b("VersaButton"), d = b("ElSpace"), p = Je("loading");
  return r.dialogVisible ? (f(), w(O(s.panelType), M({
    key: 0,
    "destroy-on-close": "",
    ...
    default: g(() => [
      ce((f(), w(n, M(r.mergedFormProps, {
        class: ["versa-modal__form", { "is-scrollable": !!r.scrollStyles }],
        ref: "formRef",
        style: r.scrollStyles,
        autoInitValue: !1,
        modelValue: a.formValues,
        "onUpdate:modelValue": t[0] || (t[0] = (l) => a.formValues = l)
      }), P({
        footer: g((l) => [
          _(e.$slots, "modalFooter", E(k(m(u({}, l), { loading: a.loading, refresh: r.initForm }))))
        ]),
        _: 2
      }, [
        C(Object.keys(e.$slots).filter(
      ...
      r.dialogActions.length ? (f(), w(d, {
        ...
        default: g(() => [
          (f(!0), v(I, null, C(r.dialogActions, (l) => (f(), v(I, {
            key: l.actionType
          }, [
            l.is ? (f(), w(O(l.is), M({
              key: 0,
    ...
    _: 3
  }, 16, ["modelValue", "before-close"])) : $("", !0);
}
const me = /* @__PURE__ */ T(Ns, [["render", Ls]]);
const Cs = {
  components: {
    VersaFilter: ke,
    VersaTable: Fe,
  ...
  created() {
    ...
    ), this.$emitter.on("VersaFormPageOnRemove", (e) => V(this, null, function* () {
...
function Ss(e, t, s, i, a, r) {
  ...
  return f(), v("div", Is, [
    ...
    }, z(r.tableListeners)), P({ _: 2 }, [
      C(Object.keys(e.$slots), (p) => ({
        name: p,
        fn: g((l) => [
          _(e.$slots, p, E(k(l)))
        ])
...
const Vs = /* @__PURE__ */ T(Cs, [["render", Ss]]);
const js = {
  name: "versa-dropdown",
  inheritAttrs: !1,
  props: {
  ...
  methods: {
    ...
    onAction(e) {
      ...
      const t = (a = this.mergedOptions) == null ? void 0 : a.find((r) => e === r.value), s = F(t, ["label", "value"]), i = H(
        s,
  ...
  render() {
    var i, a;
    if ((S(this.text) && !this.text.text || !this.text) && !this.$slots.default)
      return null;
    const e = m(u({
      placement: "bottom"
    }, this.$attrs), {
    ...
    if (this.$attrs["split-button"])
      s.push(S(this.text) ? this.text.text : this.text);
...
const Z = F(te, [
  ...
  inheritAttrs: !1,
  components: {
    VersaForm: Se(() => Promise.resolve().then(() => ms)),
    VersaButton: Y,
    VersaModal: me,
    VersaMeasureCell: xs,
    ElSpace: Q
  ...
  computed: {
    /** 是否展示新增按钮 */
    wheatherShowAddBtn() {
      return this.status === "edit" && this.hasAdd && this.formList.length < this.maxLength;
    },
    /** 是否受控 */
    isControl() {
  ...
  methods: {
    ...
    filterActions(e, t) {
      ...
      const n = r == null ? void 0 : r.map((o) => S(o) && j(o, "actionName") && j(o, "actionType") || o != null && o.is ? m(u({}, o), {
  ...
  ref: "formRef"
}, Es = { class: "versa-repeater__table" }, ks = ["width"], Fs = { class: "versa-repeater__table-header" }, Ys = { class: "versa-repeater__table-row" }, $s = { class: "versa-repeater__table-body" };
function Rs(e, t, s, i, a, r) {
  ...
  return f(), v("div", Ps, [
    L("div", {
      ...
      L("table", Es, [
        L("colgroup", null, [
          (f(!0), v(I, null, C(r.deployOptions, (c) => (f(), v("col", {
            width: c.__width || "auto"
          }, null, 8, ks))), 256))
        ]),
        L("thead", Fs, [
          L("tr", Ys, [
            (f(!0), v(I, null, C(r.deployOptions, (c) => (f(), v("th", {
              class: J([
                "versa-repeater__table-header--cell",
                `versa-repeater__table-row--${c.itemAlign || c.itemAlign}`,
                c.__fixedClass
              ]),
              style: qe(c.formItemProps.itemStyle)
            }, x(c.__label), 7))), 256))
          ])
        ]),
        L("tbody", $s, [
          L("tr", null, [
            (f(!0), v(I, null, C(r.deployOptions, (c) => (f(), w(n, {
              key: c.prop,
              measure: !!c.fixed,
              onOnResize: (y) => r.onResize(c, y)
            }, null, 8, ["measure", "onOnResize"]))), 128))
          ]),
          (f(!0), v(I, null, C(a.formList, (c, y) => (f(), w(p, {
            component: "tr",
            isRepeater: "",
            ref_for: !0,
            ref: "repeaterRows",
            ...
            r.hasOperateColumn ? {
              ...
              fn: g(() => [
                D(d, null, {
                  default: g(() => [
                    (f(!0), v(I, null, C(r.filterActions(c, y), (N) => (f(), v(I, null, [
                      N.is ? (f(), w(O(N.is), M({
                        key: 0,
                        ref_for: !0
                      }, N, z(N.on || {})), null, 16)) : (f(), w(o, M({
                        key: 1,
                        type: "primary",
                        link: "",
                        ref_for: !0
            ...
            s.index ? {
              name: "index",
              fn: g(() => [
                L("span", null, x(typeof s.index == "function" ? s.index(y) : s.index), 1)
              ]),
              key: "1"
            } : void 0
    ...
    r.wheatherShowAddBtn ? (f(), w(o, {
      ...
      _: 1
    }, 8, ["actionIcon", "onClick"])) : $("", !0),
    D(l, M(r.modalProps, {
      visible: a.visible,
      "onUpdate:visible": t[1] || (t[1] = (c) => a.visible = c)
    }), P({ _: 2 }, [
      C(Object.keys(e.$slots), (c) => ({
        name: c,
        fn: g((y) => [
          _(e.$slots, c, E(k(y)))
        ])
...
const Ye = /* @__PURE__ */ T(zs, [["render", Rs]]), Bs = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Ye
...
const Zs = /* @__PURE__ */ T(Us, [["render", Ws]]), Hs = [
  ...
  Hs.forEach((t) => {
    e.component(de(He(t.name)), t);
  });
};
export {
  Y as VersaButton,
  se as VersaCard,
  Ee as VersaCheckboxGroup,
  js as VersaDropdown,
  ke as VersaFilter,
  ie as VersaForm,
