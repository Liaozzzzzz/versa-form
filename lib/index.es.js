...
import { h, unref as _e, resolveComponent as g, openBlock as f, createElementBlock as M, normalizeClass as q, createElementVNode as _, toDisplayString as x, renderSlot as V, createVNode as D, withCtx as y, Fragment as j, renderList as S, createBlock as v, resolveDynamicComponent as k, mergeProps as w, toHandlers as Y, createTextVNode as Z, createCommentVNode as F, defineAsyncComponent as Ce, normalizeProps as z, guardReactiveProps as O, createSlots as H, withDirectives as Ie, resolveDirective as He, computed as je, normalizeStyle as Qe } from "vue";
import P from "lodash/pick";
import Q from "lodash/mapKeys";
import de from "tiny-emitter";
import R from "lodash/omit";
import { ElOption as be, ElOptionGroup as Ge, ElSelect as Je, ElMessageBox as ve, ElButton as qe, ElPopconfirm as Ke, ElSpace as $, ElTooltip as Xe, ElRadioButton as et, ElRadio as tt, ElRadioGroup as st, ElIcon as it, ElImage as rt, ElCheckboxButton as at, ElCheckbox as lt, ElCheckboxGroup as ot, ElRow as nt, ElTable as ut, ElEmpty as dt, ElPagination as ct, ElLoading as Se, ElTableColumn as U, ElDialog as ht, ElDropdownItem as pt, ElDropdown as ft, ElDropdownMenu as mt, ElMessage as yt } from "element-plus";
...
const K = (e) => ["", null, void 0].includes(e), A = (e) => e, L = (e) => Object.prototype.toString.call(e).toLocaleLowerCase() === "[object object]", C = (e, t) => Object.prototype.hasOwnProperty.call(e, t);
function ee(e) {
...
const Ct = (e, t) => {
  ...
  if (typeof t == "function")
    return t(e);
}, It = () => Math.random().toString(36).slice(2), we = (e = {}) => {
  const t = {};
  for (const s in e)
  ...
  render() {
    ...
    const e = this.mergedOptions.map((r) => {
      ...
      const a = {
        ...
        value: r.value,
        disabled: r.disabled
      }, u = ((d = r.children) == null ? void 0 : d.length) > 0, o = (c = (l = r.children) == null ? void 0 : l.map((p) => {
        const b = {
          props: {
            label: p.label,
            value: p.value,
...
const T = (e, t) => {
  ...
  computed: {
    ...
    toolActions() {
      var e, t;
      return (t = (e = this.actions) == null ? void 0 : e.map((s) => L(s) && C(s, "actionName") && C(s, "actionType") || s != null && s.is ? m(n({}, s), {
...
}, Pt = { class: "versa-card__title" }, Et = { class: "versa-card__action" }, kt = { class: "versa-card__content" };
function Yt(e, t, s, i, r, a) {
  const u = g("VersaButton"), o = g("ElSpace");
  return f(), M("div", {
    class: q(["versa-card", { "versa-card--hasTitle": s.title }])
  }, [
    s.title ? (f(), M("div", Ot, [
      _("div", Pt, x(s.title), 1),
      _("div", Et, [
        V(e.$slots, "headerRight", {}, () => [
          D(o, { size: 20 }, {
            default: y(() => [
              (f(!0), M(j, null, S(a.toolActions, (d) => (f(), M(j, null, [
                d.is ? (f(), v(k(d.is), w({
                  key: d.is,
                  ref_for: !0
                }, d, Y(d.on || {})), null, 16)) : (f(), v(u, w({
                  key: d.type,
                  size: "small",
                  ref_for: !0
                }, d, {
                  onClick: (l, c) => a.onAction(d, c)
                }), {
                  default: y(() => [
                    Z(x(d.actionName), 1)
                  ]),
...
function Wt(e, t, s, i, r, a) {
  return a.renderValue ? (f(), M("span", Bt, [
    Z(x(a.renderValue) + " ", 1),
    _("img", {
...
const Te = /* @__PURE__ */ T($t, [["render", Wt]]), Zt = "data:image/svg+xml;base64,", Ne = {
    ...
    validate(e, t = A) {
      ...
      if (s.length !== 0) {
        ...
        s && s.length > 0 && s.forEach((l) => {
          ...
          (l, c) => {
            var p;
            this.validateState = l ? "error" : "success", this.validateMessage = l ? l[0].message : "", l && (i = !1, u[this.prop].push(...c[this.prop])), typeof t == "function" && ++r === a && t(i, i ? {} : u), (p = this.VersaForm) == null || p.$emit(
              "validate",
              this.prop,
              !l,
  ...
  render() {
    var u, o, d, l, c, p, b, N, B, X, fe, me, ye;
    const e = [];
    if (this.interceptPreview) {
      ...
      e.push(...(c = (l = this.$slots).default) == null ? void 0 : c.call(l)), this.status !== "preview" && this.proxyEvent(e);
...
const Ht = {
  ...
  methods: {
    ...
    handleChange(e) {
      ...
      if (!((o = this.accept) == null ? void 0 : o.split(";").some((c) => t[0].name.endsWith(c)))) {
...
}, Qt = { class: "versa-image-upload" }, Gt = {
  key: 1,
  class: "versa-image-upload__preview"
}, Jt = /* @__PURE__ */ _("div", { class: "versa-image-upload__preview--mask" }, null, -1), qt = ["accept"];
function Kt(e, t, s, i, r, a) {
  const u = g("Plus"), o = g("ElIcon"), d = g("ElImage"), l = g("Delete");
  return f(), M("div", Qt, [
    r.previewSrc ? (f(), M("div", Gt, [
      D(d, {
    ...
    _("input", {
      ...
      type: "file",
      accept: s.accept,
      onChange: t[0] || (t[0] = (...c) => a.handleChange && a.handleChange(...c))
    }, null, 40, qt)
  ]);
}
const Oe = /* @__PURE__ */ T(Ht, [["render", Kt]]), Pe = {
...
const Le = {
  ...
  components: {
    ...
    VersaImageUpload: Oe,
    VersaRepeater: Ce(() => Promise.resolve().then(() => Vs))
  },
  mixins: [le, he],
  props: {
    /** 初始化时自动处理初始值 */
  ...
  methods: {
    ...
    bindProps(e) {
      ...
      }, Dt[e.type || "date"])), typeof e.element == "string" && /select/i.test(e.element) && Object.assign(t, {
        placeholder: `请选择${e.label || ""}`
...
function es(e, t, s, i, r, a) {
  const u = g("VersaFormItem"), o = g("ElSpace"), d = g("ElRow");
  return f(), v(k(s.component), {
    class: q([
      "versa-form",
      {
    ...
    default: y(() => [
      a.layout ? (f(), v(d, {
        ...
        default: y(() => [
          (f(!0), M(j, null, S(a.deployOptions, (l) => (f(), v(o, {
            key: l.prop,
            span: l.colSpan
          }, {
            default: y(() => [
              D(u, w({ ref_for: !0 }, a.bindFormItemProps(l), {
                prop: l.prop,
                label: l.label || "",
                rules: l.rules,
                status: l.status
                ...
                default: y(() => [
                  l.slotName ? V(e.$slots, l.slotName, w({
                    key: 0,
                    data: a.model,
                    ref_for: !0
                  }, l)) : (f(), v(k(l.element), w({ key: 1 }, Y(a.bindEvent(l)), { ref_for: !0 }, a.bindProps(l), {
                    modelValue: a.model[l.prop],
                    "onUpdate:modelValue": (c) => a.model[l.prop] = c
        ...
        _: 3
      })) : (f(!0), M(j, { key: 1 }, S(a.deployOptions, (l) => (f(), v(u, w({ ref_for: !0 }, a.bindFormItemProps(l), {
        key: l.prop,
        prop: l.prop,
        label: l.label || "",
        rules: l.rules,
      ...
      V(e.$slots, "footer", z(O({ model: a.model, actionType: e.actionType })))
    ]),
    _: 3
  }, 8, ["class"]);
}
const ie = /* @__PURE__ */ T(Xt, [["render", es]]), ts = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: ie
}, Symbol.toStringTag, { value: "Module" }));
const ss = P(te, ["reset", "create", "search"]), is = {
  name: "versa-filter",
  components: {
    VersaForm: ie,
    VersaCard: se,
  ...
  computed: {
    filterActions() {
      ...
      return typeof this.actions == "function" && (e = this.actions(this.formValues)), e == null ? void 0 : e.map((t) => typeof t == "string" ? ss[t] : L(t) && C(t, "actionName") && C(t, "actionType") || t != null && t.is ? m(n({}, t), {
...
}, rs = { class: "versa-filter__action" }, as = { class: "versa-filter__footer" };
function ls(e, t, s, i, r, a) {
  ...
  return f(), v(l, {
    ...
    default: y(() => [
      D(d, {
        ...
        "onUpdate:modelValue": t[0] || (t[0] = (c) => r.formValues = c),
        options: s.options,
        ...
        footer: y(() => [
          _("section", rs, [
            D(o, {
              ...
              default: y(() => [
                (f(!0), M(j, null, S(a.filterActions, (c) => (f(), M(j, null, [
                  c.is ? (f(), v(k(c.is), w({
                    key: 0,
                    ref_for: !0
                  }, c, Y(c.on || {})), null, 16)) : (f(), v(u, w({
                    key: c.actionType,
                    type: c.type,
                    ref_for: !0
                  }, c, {
                    onClick: (p, b) => a.onAction(c, b)
                  }), {
                    default: y(() => [
                      Z(x(c.actionName), 1)
                    ]),
                ...
                V(e.$slots, "btns", z(O(e.proxyPageCore({ formValues: r.formValues }))))
              ]),
              _: 3
            })
          ])
...
const Ee = /* @__PURE__ */ T(is, [["render", ls]]);
const os = P(te, ["remove", "edit", "detail"]), ke = {
  name: "versa-table",
  mixins: [ne, he, ce, ze],
  props: {
    /** 列表配置项 */
  ...
  computed: {
    tools() {
      var e;
      return (e = this.toolOptions) == null ? void 0 : e.map((t) => L(t) && C(t, "actionName") && C(t, "actionType") || t != null && t.is ? m(n({}, t), {
        on: we(t.on),
    ...
    renderOptions() {
      ...
      return (t = (e = this.options) == null ? void 0 : e.map((s) => {
        ...
        return i.formatter || (i.formatter = (r) => {
          var a;
          return K(r[i.prop]) ? i.filterNull || ((a = this.fillNull) != null ? a : "") : L(i.mapSource) ? i.mapSource[r[i.prop]] : r[i.prop];
  ...
  methods: {
    ...
    filterActions(e, ...t) {
      ...
      return typeof e == "function" && (s = e(...t)), s == null ? void 0 : s.map((i) => typeof i == "string" ? os[i] : L(i) && C(i, "actionName") && C(i, "actionType") || i != null && i.is ? m(n({}, i), {
        on: we(i.on),
  ...
  render() {
    const e = (t) => t.map((s) => {
      ...
      ) : s.type === "selection" ? h(U, n({
        "reserve-selection": !0
      }, s)) : s.actions ? h(U, s, {
        default: ({ row: r, column: a, $index: u }) => h(
          $,
          {},
          {
            default: () => this.filterActions(
              ...
              a,
              u
            ).map((o) => o.is ? h(g(o.is), n(n({}, o), o.on)) : h(
              E,
              m(n({
                type: "primary",
                link: !0
      ...
      }) : ((i = s.children) == null ? void 0 : i.length) > 0 ? h(U, ...R(s, ["children"]), {
        default: () => e(s.children)
      }) : s.sensitive ? h(U, s, {
        default: ({ row: r, column: a }) => h(Te, {
          value: r[a.property],
            ...
            h(
              ...
              },
              {
                default: () => {
                  var t, s;
                  return [
                    ...this.tools.map((i) => i.is ? h(g(i.is), n(n({}, i), i.on)) : h(
                      E,
                      m(n({}, i), {
              ...
              h(
                ...
                }),
                {
                  empty: () => {
                    ...
                    )) != null ? a : h(dt, { description: "暂无数据" });
                  },
                  default: () => e(this.renderOptions)
                }
              ),
              this.needPagination && this.innerParams.total > 0 ? h(ct, m(n({
...
const ns = {
  ...
  computed: {
    ...
    dialogActions() {
      let e = typeof this.actions == "string" ? this.actions.split(",") : this.actions;
      return typeof this.actions == "function" && (e = this.actions(this.formValues)), e == null ? void 0 : e.map((t) => typeof t == "string" ? ns[t] : L(t) && C(t, "actionName") && C(t, "actionType") || t != null && t.is ? m(n({}, t), {
        disabled: typeof t.disabled == "function" ? t.disabled.bind(this, this.formValues) : t.disabled
      }) : null).filter(Boolean);
    },
    /** 透传的props */
...
function ds(e, t, s, i, r, a) {
  const u = g("VersaForm"), o = g("VersaButton"), d = g("ElSpace"), l = He("loading");
  return a.dialogVisible ? (f(), v(k(s.panelType), w({
    key: 0,
    "destroy-on-close": "",
    modelValue: a.dialogVisible,
    "onUpdate:modelValue": t[1] || (t[1] = (c) => a.dialogVisible = c)
  }, a.undefProps, { "before-close": a.beforeClose }), {
    default: y(() => [
      Ie((f(), v(u, w(a.mergedFormProps, {
        ...
        footer: y((c) => [
          V(e.$slots, "modalFooter", z(O(m(n({}, c), { loading: r.loading, refresh: a.initForm }))))
        ]),
        _: 2
      }, [
        S(Object.keys(e.$slots).filter(
      ...
      a.dialogActions.length ? (f(), v(d, {
        ...
        default: y(() => [
          (f(!0), M(j, null, S(a.dialogActions, (c) => (f(), M(j, {
            key: c.actionType
          }, [
            c.is ? (f(), v(k(c.is), w({
              key: 0,
              ref_for: !0
            }, c, Y(c.on || {})), null, 16)) : F("", !0),
            D(o, w({ ref_for: !0 }, c, {
              onClick: (p, b) => a.onAction(c, b)
            }), {
              default: y(() => [
...
const pe = /* @__PURE__ */ T(us, [["render", ds]]);
const cs = {
  components: {
    VersaFilter: Ee,
    VersaTable: ke,
...
function ps(e, t, s, i, r, a) {
  const u = g("VersaFilter"), o = g("VersaTable"), d = g("VersaModal");
  return f(), M("div", hs, [
    D(u, w({ ref: "filterRef" }, a.filterProps, {
...
const fs = /* @__PURE__ */ T(cs, [["render", ps]]);
const ms = {
  name: "versa-dropdown",
  inheritAttrs: !1,
  props: {
  ...
  render() {
    ...
    if (this.$attrs["split-button"])
      ...
      const a = [this.text];
      this.icon && a.push(h("i", { class: this.icon })), s.push(
        h(
          E,
          {
            type: "primary",
...
function Ms(e, t, s, i, r, a) {
  return f(), M("td", gs, null, 512);
}
const bs = /* @__PURE__ */ T(ys, [["render", Ms]]);
class re {
  constructor(t) {
...
const W = P(te, [
  ...
  inheritAttrs: !1,
  components: {
    VersaForm: Ce(() => Promise.resolve().then(() => ts)),
    VersaButton: E,
    VersaModal: pe,
    VersaMeasureCell: bs,
    ElSpace: $
  ...
  computed: {
    ...
    deployOptions() {
      ...
      return [].concat(e, s, t).map((r) => {
        ...
        let a = "", u = "";
        if (r.fixed) {
          const l = r.fixed === "right", c = l ? "right" : "left", p = l ? [...t].reverse() : e;
          let b = 0;
          p.some((N) => {
            const B = N.prop === r.prop;
            return B || (b += this.fixedColumnWidth[N.prop] || 0), B;
          }), a = `position: sticky; ${c}: ${b}px;z-index: 2`, (l && ((o = t[0]) == null ? void 0 : o.prop) === r.prop || !l && ((d = e.slice(-1)[0]) == null ? void 0 : d.prop) === r.prop) && (u += ` versa-repeater__table-row-fixed--${c}`);
        }
        return m(n({}, r), {
          width: void 0,
          label: void 0,
  ...
  methods: {
    ...
    filterActions(e, t) {
      ...
      const u = a == null ? void 0 : a.map((o) => L(o) && C(o, "actionName") && C(o, "actionType") || o != null && o.is ? m(n({}, o), {
    ...
    onAdd() {
      return I(this, null, function* () {
        ...
        const [s, i] = yield this.handleAsyncAction(
          "add",
          m(n({}, this.initValue), { __rowKey: `repeater_${It()}` }),
          e
        );
        if (!s)
          return;
        ...
        switch (e.actionType) {
          ...
          case "save": {
            if (!(yield (u = (a = this.$refs.repeaterRows) == null ? void 0 : a[s]) == null ? void 0 : u.validate().catch((p) => (console.warn("[VersaRepeater] 保存校验失败", p), !1))))
              return;
            const [l, c] = yield this.handleAsyncAction(
              "save",
              t.values,
              s
            );
            if (!l)
              return;
            t.temporaryValues = c, t.values = c, t.status = "preview", t.isNew = !1, this.$emit("update:modelValue", this.getValues()), this.$emit("onValueChange", t, s);
            break;
          }
          case "cancel": {
            if (t.isNew) {
    ...
    validate(e) {
      ...
      if ((u = this.$refs.repeaterRows) == null || u.forEach((o, d) => {
        o.validate((l, c) => {
          l || (s = !1, Object.assign(r, { [d]: c })), typeof e == "function" && ++i === this.$refs.repeaterRows.length && e(s, r);
        });
      }), t)
        return t;
    },
  ...
  ref: "formRef"
}, Ls = { class: "versa-repeater__table" }, _s = ["width"], Cs = { class: "versa-repeater__table-header" }, Is = { class: "versa-repeater__table-row" }, js = { class: "versa-repeater__table-body" };
function Ss(e, t, s, i, r, a) {
  const u = g("VersaMeasureCell"), o = g("VersaButton"), d = g("ElSpace"), l = g("VersaForm"), c = g("VersaModal");
  return f(), M("div", Ns, [
    _("div", {
      ref: "scrollRef",
      class: q([
      ...
      _("table", Ls, [
        _("colgroup", null, [
          (f(!0), M(j, null, S(a.deployOptions, (p) => (f(), M("col", {
            width: p.__width || "auto"
          }, null, 8, _s))), 256))
        ]),
        _("thead", Cs, [
          _("tr", Is, [
            (f(!0), M(j, null, S(a.deployOptions, (p) => (f(), M("th", {
              class: q([
        ...
        _("tbody", js, [
          _("tr", null, [
            (f(!0), M(j, null, S(a.deployOptions, (p) => (f(), v(u, {
              key: p.prop,
              measure: !!p.fixed,
              onOnResize: (b) => a.onResize(p, b)
            }, null, 8, ["measure", "onOnResize"]))), 128))
          ]),
          (f(!0), M(j, null, S(r.formList, (p, b) => (f(), v(l, {
            component: "tr",
            isRepeater: "",
            ref_for: !0,
            ref: "repeaterRows",
            ...
            a.hasOperateColumn ? {
              ...
              fn: y(() => [
                D(d, null, {
                  default: y(() => [
                    (f(!0), M(j, null, S(a.filterActions(p, b), (N) => (f(), M(j, null, [
                      N.is ? (f(), v(k(N.is), w({
                        key: 0,
                        ref_for: !0
                      }, N, Y(N.on || {})), null, 16)) : (f(), v(o, w({
                        key: 1,
                        type: "primary",
                        link: "",
                        ref_for: !0
...
const Ye = /* @__PURE__ */ T(ws, [["render", Ss]]), Vs = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Ye
...
const Ts = /* @__PURE__ */ T(Ds, [["render", As]]), xs = [
  fs,
  Ee,
  ke,
  ie,
